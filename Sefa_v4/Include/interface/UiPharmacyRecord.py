...
class Ui_PharmacyRecord(object):
    ...
    def retranslateUi(self, PharmacyRecord):
        PharmacyRecord.setWindowTitle(QCoreApplication.translate("PharmacyRecord", u"Pharmaceutical Record", None))
        self.label_12.setText(QCoreApplication.translate("PharmacyRecord", u"Patient's ID:", None))
        self.patientID.setText(QCoreApplication.translate("PharmacyRecord", u"000000000", None))
        self.groupBox.setTitle(QCoreApplication.translate("PharmacyRecord", u"Patient's Details:", None))
        self.label_5.setText(QCoreApplication.translate("PharmacyRecord", u"First Name:", None))
        self.fname.setText("")
        self.label_9.setText(QCoreApplication.translate("PharmacyRecord", u"Gender:", None))
        self.gender.setText("")
        self.label_4.setText(QCoreApplication.translate("PharmacyRecord", u"Age:", None))
        self.age.setText("")
        self.label_2.setText(QCoreApplication.translate("PharmacyRecord", u"Last Name:", None))
        self.label_6.setText(QCoreApplication.translate("PharmacyRecord", u"Class:", None))
        self.lname.setText("")
        self.pclass.setText("")
        self.label_10.setText(QCoreApplication.translate("PharmacyRecord", u"Status:", None))
        self.status.setText("")
        ___qtablewidgetitem = self.table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("PharmacyRecord", u"Date", None));
        ___qtablewidgetitem1 = self.table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("PharmacyRecord", u"Dispense Date", None));
        ___qtablewidgetitem2 = self.table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("PharmacyRecord", u"Doctor", None));
        ___qtablewidgetitem3 = self.table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("PharmacyRecord", u"Pharmacist", None));
        ___qtablewidgetitem4 = self.table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("PharmacyRecord", u"Diagnosis", None));
        ___qtablewidgetitem5 = self.table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("PharmacyRecord", u"Prescription", None));
        ___qtablewidgetitem6 = self.table.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("PharmacyRecord", u"Status", None));
