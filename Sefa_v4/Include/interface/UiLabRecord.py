...
class Ui_LabRecord(object):
    ...
    def retranslateUi(self, LabRecord):
        LabRecord.setWindowTitle(QCoreApplication.translate("LabRecord", u"Lab Record", None))
        self.label_12.setText(QCoreApplication.translate("LabRecord", u"Patient's ID:", None))
        self.patientID.setText(QCoreApplication.translate("LabRecord", u"000000000", None))
        self.groupBox.setTitle(QCoreApplication.translate("LabRecord", u"Patient's Details:", None))
        self.label_5.setText(QCoreApplication.translate("LabRecord", u"First Name:", None))
        self.fname.setText("")
        self.label_9.setText(QCoreApplication.translate("LabRecord", u"Gender:", None))
        self.gender.setText("")
        self.label_4.setText(QCoreApplication.translate("LabRecord", u"Age:", None))
        self.age.setText("")
        self.label_2.setText(QCoreApplication.translate("LabRecord", u"Last Name:", None))
        self.label_6.setText(QCoreApplication.translate("LabRecord", u"Class:", None))
        self.lname.setText("")
        self.pclass.setText("")
        self.label_10.setText(QCoreApplication.translate("LabRecord", u"Status:", None))
        self.status.setText("")
        ___qtablewidgetitem = self.table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("LabRecord", u"Request Date", None));
        ___qtablewidgetitem1 = self.table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("LabRecord", u"Collection Date", None));
        ___qtablewidgetitem2 = self.table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("LabRecord", u"Doctor", None));
        ___qtablewidgetitem3 = self.table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("LabRecord", u"Lab Scientist", None));
        ___qtablewidgetitem4 = self.table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("LabRecord", u"Diagnosis", None));
        ___qtablewidgetitem5 = self.table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("LabRecord", u"Experiment", None));
        ___qtablewidgetitem6 = self.table.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("LabRecord", u"Pathology", None));
        ___qtablewidgetitem7 = self.table.horizontalHeaderItem(7)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("LabRecord", u"Specimen", None));
        ___qtablewidgetitem8 = self.table.horizontalHeaderItem(8)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("LabRecord", u"Test Result", None));
