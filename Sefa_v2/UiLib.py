...
inpfile  = "C:\\Users\\Admin\\Pictures\\UI_designs\\Sefa_HIMS_v2"

logoOut  = sys.path[0]+"\\resources\\icons"
imageOut = sys.path[0]+"\\resources\\images"
outpfile = sys.path[0]+"\\interface"
